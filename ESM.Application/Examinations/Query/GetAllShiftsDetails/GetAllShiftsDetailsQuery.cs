...
namespace ESM.Application.Examinations.Query.GetAllShiftsDetails;

public record GetAllShiftsDetailsQuery(string Id) : IRequest<Result<List<ShiftDetailsDto>>>;

public class GetAllShiftsDetailsQueryHandler
    : IRequestHandler<GetAllShiftsDetailsQuery, Result<List<ShiftDetailsDto>>>
{
